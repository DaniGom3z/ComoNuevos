...
const IniciarSesion = () => {
  ...
  const handleRegistration = async () => {
    ...
    try {
      ...
      const respuesta = await fetch('http://localhost:9000/registro', {
        method: 'POST',
        mode: 'cors',
        headers: {
          'Content-Type': 'application/json',
      ...
      if (respuesta.ok) {
        ...
        toast.success("usuario creado exitosamente, inicia sesion para continuar", { position: toast.POSITION.BOTTOM_RIGHT })
      ...
      toast.error("error al crear el usuario", { position: toast.POSITION.BOTTOM_RIGHT })
